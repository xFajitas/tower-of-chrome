...
namespace TowerOfChrome.Core.Tests.Persistence;
...
public class SaveLoadRoundtripTests : IDisposable
{
    ...
    private static GameSessionState MakeMinimalState(int currentFloor = 1, TowerOfChrome.Core.Dungeon.DungeonFloor? dungeonFloor = null)
    {
        var party = Party.DefaultParty(TestGameData.NewClassRegistry(), TestGameData.NewItemRegistry(), TestGameData.NewLeveling());
